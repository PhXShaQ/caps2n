...
<html lang="en">
    ...
    <body>
        <div class="sidebar">
            ...
            <a href="designhome.php" class="menu-item" style="background: var(--purple); color: white;"><i data-lucide="house"></i> Home</a>
            ...
            <div class="content-body">
                <div class="container2">
                    ...
                    <div class="card-container">
                        ...
                        <div class="card" onclick="navigateTo('design1.php')">
                        ...
                        <div class="card" onclick="navigateTo('design4.php')">
                            <div class="icon">🎵</div>
                            <p>Text to Audio/p>
                        </div>
